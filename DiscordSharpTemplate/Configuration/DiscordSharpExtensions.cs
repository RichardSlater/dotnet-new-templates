...
public static class DiscordSharpExtensions {
    public static IServiceCollection AddDiscord(this IServiceCollection services, ConfigurationRoot config) {
        return services.AddSingleton<DiscordClient>(serviceProvider => {
            ...
            var client = new DiscordClient(new DiscordConfiguration {
                ...
                Token = config.Discord.BotToken ?? throw new InvalidOperationException("BotToken missing from configuration."),
